...
- **Suggested command**: Which command could address this (from: craft, init, document, extract, live, generate, adapt, animate, audit, bolder, clarify, colorize, critique, delight, distill, harden, onboard, layout, optimize, overdrive, polish, quieter, shape, typeset)
...
- Only recommend commands from: craft, init, document, extract, live, generate, adapt, animate, audit, bolder, clarify, colorize, critique, delight, distill, harden, onboard, layout, optimize, overdrive, polish, quieter, shape, typeset
