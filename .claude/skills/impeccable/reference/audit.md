...
- **Suggested command**: Which command to use (prefer: craft, init, document, extract, live, generate, adapt, animate, audit, bolder, clarify, colorize, critique, delight, distill, harden, onboard, layout, optimize, overdrive, polish, quieter, shape, typeset)
...
**Rules**: Only recommend commands from: craft, init, document, extract, live, generate, adapt, animate, audit, bolder, clarify, colorize, critique, delight, distill, harden, onboard, layout, optimize, overdrive, polish, quieter, shape, typeset. Map findings to the most appropriate command. End with `/impeccable polish` as the final step if any fixes were recommended.
